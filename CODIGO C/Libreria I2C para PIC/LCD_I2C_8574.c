...
//inicializa_lcd_i2c();   -- inicia el LCD
//escrever_lcd_i2c(char caractere)-- equivalente al lcd_putc();
//limpar_lcd_i2c();	-- limpia el lcd
//lcd_i2c_irpara_xy(,); -- equivalente al lcd_gotoxy();
//escrever_cgram_lcd_i2c(,); -- equivalente al lcd_cgram_char(); se usa para crear caracteres 
